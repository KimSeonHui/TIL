...
public class MainActivity extends AppCompatActivity {
   ...
   // private String html = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightPowerImage = findViewById(R.id.lightPower);
                ...
                switch (v.getId()) {
                    case R.id.outModeButton :
                        if(lightType == LightType.ON) {
                            lightPowerImage.setImageResource(R.drawable.off);
                            lightType = LightType.OFF;
                            logText.setText("외출모드! 전원 OFF");
                        }
                        else {
                    ...
                    case R.id.inModeButton :
                        if(lightType == LightType.ON) {
                            ...
                            if(currentLux < standardLux) {
                                lightPowerImage.setImageResource(R.drawable.on);
